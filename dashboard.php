...
<body>
  <nav>
    <a href="#"><img class="logo" src="AA brandmark.jpg" alt="Averess logo" /></a>
    <a href="#" class="active">Beranda</a>
    <a href="explor.php">Jelajahi</a>
    <a href="create.php">Buat</a>
    <input type="text" class="search" placeholder="Search" />
    <a href="Notifikasi2.html" class="icon"><i class="fas fa-bell"></i></a>
    <a href="pesan1.html" class="icon"><i class="fas fa-comment-dots"></i></a>
    <a href="login.php">Login</a>
  </nav>
  <div class="container">
    <div class="box"><img src="img1.jpeg" alt="Image 1" /></div>
    <div class="box"><img src="img2.jpeg" alt="Image 2" /></div>
    <div class="box"><img src="img3.jpeg" alt="Image 3" /></div>
    <div class="box"><img src="img4.jpeg" alt="Image 4" /></div>
    <div class="box"><img src="img5.jpeg" alt="Image 5" /></div>
    <div class="box"><img src="img1.jpeg" alt="Image 1" /></div>
    <div class="box"><img src="img2.jpeg" alt="Image 2" /></div>
    <div class="box"><img src="img3.jpeg" alt="Image 3" /></div>
    <div class="box"><img src="img4.jpeg" alt="Image 4" /></div>
